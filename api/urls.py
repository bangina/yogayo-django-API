...
from posts.views import PostList, PostRetrieveDestroy, CommentList, Category, FileUploadView
...
urlpatterns = [
    ...
    path("api/posts/upload/", FileUploadView.as_view()),  # Post 리스트 뷰
    path("api/posts/<int:pk>/", PostRetrieveDestroy.as_view()),
    path("api/posts/<category>/", Category.as_view()),
    # path("api/posts/mypost/", MyPost.as_view()),
